        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                I am <span className="text-white font-bold drop-shadow">Akshay H</span>, a B.E. student in Artificial Intelligence and Machine Learning at Alva's Institute of Engineering & Technology, Moodbidri.
              </p>
              <p className="text-sm md:text-base text-white/60 font-light leading-relaxed">
                My technical narrative bridges machine learning and computer vision with full-stack software architecture — building AI-powered applications, training and optimizing models, and shipping real-world tools with Python, FastAPI, Flask, and React.
              </p>
            </div>
            ...
            <div className="space-y-5 relative z-10">
              ...
              <ul className="space-y-3.5 text-sm text-white/80 font-light">
                <li className="flex items-start gap-2.5">
                  ...
                  <span>1st Place at <strong className="text-white">JAGRUTHI 2024 Safety Hackathon</strong> for an AI accident detection system.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Top 5 Finalist at the <strong className="text-white">Avinya Techknows Hackathon</strong>, Bangalore.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Certified in <strong className="text-white">Google Cloud Data Analytics</strong> & <strong className="text-white">Anthropic MCP</strong>.</span>
                </li>
              </ul>
            </div>
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 relative z-10">
              {['Python', 'React', 'FastAPI', 'Flask', 'MySQL', 'MongoDB', 'Docker'].map((tech, idx) => (
                <span
                  key={idx}
