...
const expertiseData = [
  {
    ...
    text: "Building, training, and optimizing machine learning models — from NLP and computer vision pipelines to LangChain and Google Gemini LLM integrations.",
    tag: "INTELLIGENCE & ML",
  ...
  },
  {
    ...
    text: "Combining real-time computer vision with IoT sensors and GPS for systems like accident detection and automated attendance recognition.",
    tag: "VISION & SENSING",
  ...
  },
  {
    ...
    text: "Architecting REST APIs and web applications with FastAPI, Flask, and React, backed by MySQL, MongoDB, PostgreSQL, and Firebase.",
  ...
  },
  {
    ...
    text: "Cleaning and analyzing complex datasets for data-driven insights, and deploying services with Docker, Kubernetes, and Zoho Catalyst.",
    tag: "DATA & DEVOPS",
