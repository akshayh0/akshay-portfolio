...
const Contact = () => {
  ...
  return (
    <section ref={ref} id="contact" className="bg-[#0b0b0b] w-full min-h-screen relative overflow-hidden flex items-center justify-center py-20 md:py-28 px-4 sm:px-6 lg:px-8 border-t border-white/10 select-none">
      ...
      {/* Form Card Overlay */}
      <div className="relative z-10 w-full max-w-5xl mx-auto flex justify-center items-center">
        <motion.div 
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="bg-[#141414]/95 backdrop-blur-2xl border border-white/15 w-full p-8 md:p-14 lg:p-16 text-white flex flex-col justify-between rounded-3xl md:rounded-[2.5rem] shadow-[0_20px_60px_rgba(0,0,0,0.9)] relative overflow-hidden"
        >
          {/* Subtle internal top crimson highlight glow */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-1 bg-gradient-to-r from-transparent via-red-600 to-transparent opacity-90"></div>
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-6">
                  ...
                  <div className="flex items-center gap-3">
                    <a
                      ...
                      className="px-6 py-3.5 rounded border border-white/20 text-white font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-2 hover:border-red-600 hover:bg-red-600/10 transition-all duration-300 whitespace-nowrap hover:scale-105"
                    >
