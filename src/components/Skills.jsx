...
const skillCategories = [
  { 
    ...
    desc: 'Building and evaluating machine learning models using NumPy, Pandas, and Scikit-learn, with hands-on model building and dataset processing.', 
    tag: 'AI / ML',
    skills: ['Python', 'NumPy', 'Pandas', 'Scikit-learn', 'TensorFlow'] 
  },
  { 
    title: 'NLP, CV & LLMs', 
    desc: 'Developing intelligent applications leveraging natural language processing, computer vision, and LLM-driven workflows.', 
    tag: 'INTELLIGENCE',
    skills: ['NLP', 'Computer Vision', 'LangChain', 'Gemini API', 'LLMs'] 
  },
  { 
    title: 'Frontend & Backend', 
    desc: 'Building responsive interfaces and REST APIs, connecting React front ends to FastAPI and Flask backends.', 
    tag: 'FULL-STACK',
    skills: ['React.js', 'JavaScript', 'FastAPI', 'Flask', 'Node.js'] 
  },
  { 
    title: 'Databases', 
    desc: 'Designing and managing relational and NoSQL data stores for real-world applications.', 
    tag: 'DATA STORAGE',
    skills: ['MySQL', 'MongoDB', 'PostgreSQL', 'Firebase', 'Supabase'] 
  },
  { 
    title: 'Tools & DevOps', 
    desc: 'Working across version control, containerization, and workflow automation for reliable, repeatable builds.', 
    tag: 'INFRASTRUCTURE',
    skills: ['Git', 'GitHub', 'Docker', 'Kubernetes', 'N8N'] 
  },
  { 
    title: 'CS Fundamentals', 
    desc: 'Grounded in core computer science principles that underpin every system built above.', 
    tag: 'FOUNDATIONS',
    skills: ['Data Structures', 'Algorithms', 'OOPs', 'DBMS', 'Networks'] 
  },
];
